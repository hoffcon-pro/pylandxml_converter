...
Writes:
  .obj, .off, .ply, .stl, .mesh

Examples:
  python landxml_convert.py input.xml -o out -f obj -f ply -f stl
  python landxml_convert.py input.xml -s "Existing Ground" -s "Design"
  python landxml_convert.py input.xml --all-formats
"""
...
def main(
    ...
    Examples:
      python landxml_convert.py 3-AWC66.00_PR.xml -o out -f obj -f ply
      python landxml_convert.py 3-AWC66.00_PR.xml --all-formats
